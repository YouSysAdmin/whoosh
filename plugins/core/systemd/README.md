...
The plugin is **bundled and on by default** - the actions are available in every binary without a `plugins:` entry.
...
Full docs: [whoosh.yousysadmin.com/plugins/systemd](https://whoosh.yousysadmin.com/plugins/systemd/)
